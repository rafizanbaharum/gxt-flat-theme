 ...
 */
package net.canang.theme.flat.client.tools;
...
public class FlatTools extends Tools {

  public interface FlatToolResources extends ToolResources, ClientBundle {
  ...
  public FlatTools() {
    super(GWT.<ToolResources> create(FlatToolResources.class));
  }
