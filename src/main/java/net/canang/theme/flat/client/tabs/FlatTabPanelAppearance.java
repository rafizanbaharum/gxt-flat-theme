...
public class FlatTabPanelAppearance extends TabPanelBaseAppearance {

  public interface FlatTabPanelResources extends TabPanelResources, ClientBundle {
    ...
    @Source({"com/sencha/gxt/theme/base/client/tabs/TabPanel.css", "FlatTabPanel.css"})
    FlatTabPanelStyle style();
  ...
  public interface FlatTabPanelStyle extends TabPanelStyle {
  }

  public FlatTabPanelAppearance() {
    this(GWT.<FlatTabPanelResources> create(FlatTabPanelResources.class), GWT.<Template> create(Template.class),
        GWT.<ItemTemplate> create(ItemTemplate.class));
  }

  public FlatTabPanelAppearance(FlatTabPanelResources resources, Template template, ItemTemplate itemTemplate) {
